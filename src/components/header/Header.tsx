...
const Header: React.FC<HeaderProps> = ({ isConnected }) => {
  ...
  const { connectedUser, setConnectedUser } = useContext(ConnectedContext);
  ...
  return (
    <>
      {isConnected && (
        <header className="primary-header identified" data-status={connectedUser?.user_status}>
          <div className="container">
            <div className="primary-header-content">
              ...
              >
                <img src={`${process.env.PUBLIC_URL}/images/avatars/member_3.png`} alt="user iimage" />
              </div>
              <div
                ref={dropDownMenuRef}
                  ...
                  <ul className="dropdown-list">
                    <li className="dropdown-item user-profile-item">
                      <div className="user-image dropdown-item-user-image">
                        <img
                          src={`${process.env.PUBLIC_URL}/images/avatars/member_3.png`}
                          alt="user iimage"
                        />
                      </div>
                      <div className="user-infos">
                        <div className="username">{connectedUser?.username}</div>
                        <div className="user-status">{connectedUser?.user_status}</div>
                      </div>
                      <select
                        className="user-edit-status"
                        name="status"
                        id="status"
                        defaultValue={connectedUser.user_status}
                        onChange={(e) =>
                          setConnectedUser((previousValue: any) => ({
                            ...previousValue,
